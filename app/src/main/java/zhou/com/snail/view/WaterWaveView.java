...
public class WaterWaveView extends View {
    ...
    private int mRingSTROKEWidth = 0;
    private int mCircleSTROKEWidth = 6;
    ...
    private int mAlpha = 60;// 透明度
    private float mAmplitude = 16.0F; // 振幅
    private float mWaterLevel = 0.4F;// 水高(0~1)
    private Path mPath;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //与圆半径的偏移量  ------------刚刚修改的地方---------------
        float offsetWidth = mScreenWidth / 4 - waveWidth+11;
